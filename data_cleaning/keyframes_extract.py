...
if __name__ == "__main__":
    ...
    # 读取 JSON 文件
    json_path = os.path.join(workspace_root, "data/processed/val_cleaned/val_cleaned.json")
    with open(json_path, 'r', encoding='utf-8') as f:
        data = json.load(f)

    # 关键帧输出目录
    base_output_dir = os.path.join(workspace_root, "data/processed/val_cleaned/keyframes")
